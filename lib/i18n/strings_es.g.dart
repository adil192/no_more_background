...
class _Translations$apps$title$es extends Translations$apps$title$en {
	...
	// Translations
	@override String get searchYourApps => 'Busca en tus aplicaciones';
	@override String get yourApps => 'Tus aplicaciones';
}
...
class _Translations$apps$menu$backgroundData$es extends Translations$apps$menu$backgroundData$en {
	...
	@override String get restricted => 'Desactivar el uso de datos móviles en segundo plano';
	@override String get unrestricted => 'Habilitar el uso en segundo plano de los datos móviles';
}
